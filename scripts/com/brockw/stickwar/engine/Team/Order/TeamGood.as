package com.brockw.stickwar.engine.Team.Order
{
   ...
   import flash.utils.Dictionary;
     ...
     public class TeamGood extends Team
     {
      ...
      {
         if(userInterface.gameScreen is SingleplayerGameScreen && userInterface.gameScreen.isDebug && userInterface.keyBoardState.isPressed(77))
         {
            userInterface.gameScreen.doMove(new UnitCreateMove(Unit.U_MAGIKILL),this.id);
         }
