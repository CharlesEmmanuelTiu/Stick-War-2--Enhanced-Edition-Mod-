package com.brockw.stickwar.engine.units
{
    ...
    public class Undead extends Unit
    {
        ...
        override public function init(game:StickWar):void
        {
            ...
            drawShadow();
            var ct:ColorTransform = new ColorTransform(0.7, 1.0, 0.5, 1, 30, 0, 0, 0);
        ...
        override public function update(game:StickWar):void
        {
            ...
            if(game.frame % 30 == 0 && this.team != null && this.team.enemyTeam != null && Boolean(this.team.enemyTeam.deadUnits))
            {
                ...
                var i:int;
                for(i = deadUnits.length - 1; i >= 0; i--)
                {
                    ...
                    if(corpse.isInfected && corpse.timeOfDeath >= 300)
                    {
                        ...
                        if(undead != null)
                        {
                            ...
                            switch(corpse.type)
                            {
                                case Unit.U_SPEARTON: headSkin = "Undead Spearton"; break;
                                case Unit.U_NINJA: headSkin = "Undead Ninja"; break;
                                case Unit.U_MAGIKILL: headSkin = "Undead Magikill"; break;
                            }
